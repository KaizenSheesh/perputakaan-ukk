...
class LoanController extends Controller
{
    ...
    {
        return view('peminjamBuku.index', ['loans' => Auth::user()->activeLoans()]);
    }
    ...
    public function store(Book $book, Request $request): RedirectResponse
    {
        ...
        if ($validator->fails()) {
            return to_route('peminjamBuku.create', ['book' => $book])
        ...
        return to_route('peminjamBuku.index')
            ->with('status', 'Peminjaman Buku Berhasil');
    }

    public function create(Book $book): View
    {
        return view('peminjamBuku.create', ['book' => $book]);
    }
    ...
    public function terminate(Loan $loan): RedirectResponse
    {
        ...
        return to_route('peminjamBuku.index')
            ->with('status', 'Pengembalian Buku Berhasil');
    }
}
