...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight text-gray-900 dark:text-gray-100">Laporan Peminjaman</h2>
    </x-slot>
                    ...
                    <table class="mx-auto bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm sm:rounded-lg">
                        ...
                        <tbody class="font-normal">
                            ...
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-gray-200">{{ $loan->user->name }}</td>
